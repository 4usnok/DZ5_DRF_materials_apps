...
```
git clone https://github.com/4usnok/materials_apps.git
```
...
команда -> `git clone https://github.com/4usnok/materials_apps.git`
...
Команда -> `git ls-tree -r origin/develop`, где нужно поменять homework_35_2 на свою ветку
